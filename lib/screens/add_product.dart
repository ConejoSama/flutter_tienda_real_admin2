...
import 'package:flutter_tienda_real_admin/db/product.dart';
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    if (value.isEmpty) {
                      ...
                      return 'Product name cant have more than 40 letters';
                    }
                  },
                ),
              ),
      ...
      if (_image1 != null) {
        if (selectedSizes.isNotEmpty) {
          ...
          task1.onComplete.then((snapshot3) async {
            ...
            Firestore.instance.collection(ref).document(productId).setData({
